    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CollatedPrintOption", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PagePerSheet", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "PrintPageOption",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PrintPageOption", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SidePrintOption", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ApplicationUserProfilePhotos_AspNetUsers_ApplicationUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CollatedPrintOptionId = table.Column<int>(type: "int", nullable: false),
                    OrientationId = table.Column<int>(type: "int", nullable: false),
                    LetterId = table.Column<int>(type: "int", nullable: false),
                    PagePerSheetId = table.Column<int>(type: "int", nullable: false),
                    PrintPageOptionId = table.Column<int>(type: "int", nullable: false),
                    SidePrintOptionId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Requests_CollatedPrintOption_CollatedPrintOptionId",
                        column: x => x.CollatedPrintOptionId,
                        principalTable: "CollatedPrintOption",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Requests_Letter_LetterId",
                        column: x => x.LetterId,
                        principalTable: "Letter",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Requests_Orientation_OrientationId",
                        column: x => x.OrientationId,
                        principalTable: "Orientation",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Requests_PagePerSheet_PagePerSheetId",
                        column: x => x.PagePerSheetId,
                        principalTable: "PagePerSheet",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Requests_PrintPageOption_PrintPageOptionId",
                        column: x => x.PrintPageOptionId,
                        principalTable: "PrintPageOption",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Requests_SidePrintOption_SidePrintOptionId",
                        column: x => x.SidePrintOptionId,
                        principalTable: "SidePrintOption",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Requests_CollatedPrintOptionId",
                table: "Requests",
                column: "CollatedPrintOptionId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Requests_LetterId",
                table: "Requests",
                column: "LetterId");

            migrationBuilder.CreateIndex(
                name: "IX_Requests_OrientationId",
                table: "Requests",
                column: "OrientationId");

            migrationBuilder.CreateIndex(
                name: "IX_Requests_PagePerSheetId",
                table: "Requests",
                column: "PagePerSheetId");

            migrationBuilder.CreateIndex(
                name: "IX_Requests_PrintPageOptionId",
                table: "Requests",
                column: "PrintPageOptionId");

            migrationBuilder.CreateIndex(
                name: "IX_Requests_SidePrintOptionId",
                table: "Requests",
                column: "SidePrintOptionId");
        }
